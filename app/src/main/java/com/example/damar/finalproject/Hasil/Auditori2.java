...
public class Auditori2 extends AppCompatActivity {
    ...
    String ket1 = "Metode ini bertujuan untuk tukar menukar gagasan, pemikiran, informasi/pengalaman diantara peserta, sehingga dicapai kesepakatan pokok-pokok pikiran (gagasan, kesimpulan).\n";
    String hasil2 = "Metode Panel dan Seminar";
    String ket2 = "Metode Panel yaitu cara pembahasan suatu masalah melalui suatu kegiatan diskusi yang dilakukan oleh beberapa ahli dari berbagai keahlian dihadapi oleh warga belajar.\n";
    String hasil3 = "Metode Sumbang Saran";
    String ket3 = "Metode sumbang saran adalah suatu bentuk diskusi dalam rangka menghimpun gagasan, pendapat, informasi, pengetahuan, pengalaman dari semua peserta. Berbeda dengan diskusi, dimana gagasan dari seseorang ditanggapi (didukung, dilengkapi, dikurangi, atau tidak disepakati) oleh peserta lain, pada penggunaan metode curah pendapat orang lain tidak untuk ditanggapi.\n";
