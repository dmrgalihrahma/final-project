...
public class Visual2 extends AppCompatActivity {
    ...
    String ket1 = "Metode Pembelajaran Resitasi adalah suatu metode pengajaran dengan mengharuskan siswa membuat resume dengan kalimat sendiri.\n";
    ...
    String ket3 = "Desain berpikir adalah filsafat, pola pikir, dan metodologi. suatu cara berpikir yang praktis dan kreatif dalam memecahkan suatu masalah atau pekerjaan.\n";
